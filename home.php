			...
			<div class="container">
				...
				<?php if (get_option('deepfocus_blog_style') == 'false') { ?>
					...
					<div class="service" id="blog">
						...
						<div id="blog-wrapper">
							<div id="blog-content">
								<h4 class="widgettitle"><?php esc_html_e('Recent Authoring','DeepFocus'); ?></h4>
								<div class="recentscroll">
									<ul>
										<?php query_posts("posts_per_page=".get_option('deepfocus_fromblog_number')."&cat=255,".get_catId(get_option('deepfocus_blog_cat')));
					...
					<h3 class="hometitle recentworks"><?php esc_html_e('Recent Photos','DeepFocus'); ?></h3>
